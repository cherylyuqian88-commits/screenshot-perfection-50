      ...
      <div className="grid grid-cols-2 gap-4 max-xl:grid-cols-1">
        <Card>
          ...
          <div className="flex flex-col gap-3">
            <TimelineItem title="2026-04-08 15:20" desc={'患者李某确认切换当前服务机构为"深圳爱眼低视力中心"，原机构记录保留。'} />
            <TimelineItem title="2026-03-10 09:12" desc="患者王某仍在杭州康复门诊服务中，本机构仅可查看脱敏字段。" />
          </div>
        </Card>
        <Card>
          <PanelTitle title="切换规则"><Tag variant="warn">统一口径</Tag></PanelTitle>
          <div className="flex flex-col gap-3">
            <TimelineItem title="当前服务机构来源" desc="按患者最后一次确认让机构医生切换绑定机构的结果计算。" />
