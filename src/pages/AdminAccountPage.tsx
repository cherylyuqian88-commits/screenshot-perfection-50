...
export default function AdminAccountPage({ onLogout }: Props) {
  ...
  return (
    <div className="animate-fade-in">
      <Card>
        ...
        <KV label="账号" value="admin_001" />
        <KV label="姓名" value="系统管理员" />
        <KV label="所属机构" value="深圳爱眼低视力中心" />
        <KV label="角色" value="管理员" />
      ...
      <Dialog open={pwdOpen} onOpenChange={setPwdOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Btn variant="primary" onClick={() => { toast("管理员密码修改成功"); setPwdOpen(false); }}>确认修改</Btn>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
